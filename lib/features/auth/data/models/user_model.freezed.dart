...
mixin _$UserModel {
 ...
 String get uid; String get email; String get username; String? get avatarUrl;@JsonKey(fromJson: _timestampFromJson, toJson: _timestampToJson) DateTime get createdAt; String? get bio; List<String> get serverIds;
...
@useResult
$Res call({
 String uid, String email, String username, String? avatarUrl,@JsonKey(fromJson: _timestampFromJson, toJson: _timestampToJson) DateTime createdAt, String? bio, List<String> serverIds
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String uid,  String email,  String username,  String? avatarUrl, @JsonKey(fromJson: _timestampFromJson, toJson: _timestampToJson)  DateTime createdAt,  String? bio,  List<String> serverIds)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _UserModel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String uid,  String email,  String username,  String? avatarUrl, @JsonKey(fromJson: _timestampFromJson, toJson: _timestampToJson)  DateTime createdAt,  String? bio,  List<String> serverIds)  $default,) {final _that = this;
switch (_that) {
case _UserModel():
return $default(_that.uid,_that.email,_that.username,_that.avatarUrl,_that.createdAt,_that.bio,_that.serverIds);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String uid,  String email,  String username,  String? avatarUrl, @JsonKey(fromJson: _timestampFromJson, toJson: _timestampToJson)  DateTime createdAt,  String? bio,  List<String> serverIds)?  $default,) {final _that = this;
switch (_that) {
case _UserModel() when $default != null:
return $default(_that.uid,_that.email,_that.username,_that.avatarUrl,_that.createdAt,_that.bio,_that.serverIds);case _:
  return null;
...
class _UserModel extends UserModel {
  const _UserModel({required this.uid, required this.email, required this.username, this.avatarUrl, @JsonKey(fromJson: _timestampFromJson, toJson: _timestampToJson) required this.createdAt, this.bio, final  List<String> serverIds = const []}): _serverIds = serverIds,super._();
